...
export default function AuthPage({ onLogin }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Chỉ gọi onLogin — App.jsx chịu trách nhiệm lưu vào localStorage
      // (trước đây AuthPage lưu key "token" còn App.jsx lưu key "admin_token" -> lệch nhau)
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-header">
          <img src={waterLogo} alt="Water Tracker" className="auth-logo" />
